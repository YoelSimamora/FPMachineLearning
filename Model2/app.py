...
def show_home():
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr)); gap: 2rem; margin-top: 1rem;">
        <div class="feature-card">
            ...
            <p>Menggunakan arsitektur CNN canggih yang telah dilatih dengan ribuan gambar bahasa isyarat untuk mencapai akurasi hingga 96%</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">⚡</div>
...
def show_about():
    ...
    with col1:
        ...
        <div class="card">
            ...
            <p style="color: var(--light-text); font-size: 1.1rem; line-height: 1.7;">
                Sistem kami mencapai akurasi <strong>96.62%</strong> pada dataset uji, dengan waktu deteksi rata-rata hanya <strong>1.8 detik</strong> per gambar.
            </p>
        </div>
        """, unsafe_allow_html=True)
    ...
    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem; margin: 2rem 0;">
        <div style="background: linear-gradient(to right, #10b981, #34d399); color: white; padding: 1.5rem; border-radius: 10px; text-align: center;">
            <div style="font-size: 2rem; font-weight: 700;">96.62%</div>
    ...
    team = [
        {"photo": "C:/Users/lenovo/OneDrive/ITS/FP SML/images/Naomi Gloria Pasaribu.png", "name": "Naomi Gloria Pasaribu", "role": "Machine Learning Engineer"},
        {"photo": "C:/Users/lenovo/OneDrive/ITS/FP SML/images/Nurfajriyani.png", "name": "Nurfajriyani", "role": "Data Scientist"},
        {"photo": "C:/Users/lenovo/OneDrive/ITS/FP SML/images/Famita Wibi Wulandari.png", "name": "Famita Wibi Wulandari", "role": "Frontend Developer"},
        {"photo": "C:/Users/lenovo/OneDrive/ITS/FP SML/images/Anindya Putri Noliza.png", "name": "Anindya Putri Noliza", "role": "UI/UX Designer"},
    ]
